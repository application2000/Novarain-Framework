...
class JFormFieldNR_MenuItems extends NRFormField
{
	...
	protected function getInput()
	{
		...
		NRFunctions::loadLanguage('com_menus', JPATH_ADMINISTRATOR);

		$options = $this->getMenuItems();

		require_once dirname(__DIR__) . '/helpers/html.php';

		return NRHtml::selectlist($options, $this->name, $this->value, $this->id, $size, $multiple);
	}
